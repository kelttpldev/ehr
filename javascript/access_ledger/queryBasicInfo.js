...
async function queryBasicInfo(USER_NAME, CHANNEL_NAME, ORG_NAME, ID) {
    try {
        ...
        const result = await contract.evaluateTransaction("queryBasicInfo");
        // console.log(
